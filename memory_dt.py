...
if __name__ == "__main__":
    ...
    if args.stats_only:
        ...
        # train memory dt
        print(f"Training Memory Decision Transformer on {args.env} with memory type {args.memory}")
        ...
        result_path = f"results/{args.env}_dt_{memory_type}_trainlog.csv"
        df.to_csv(result_path, index=False)
        print(f"Saved training log to {result_path}")
